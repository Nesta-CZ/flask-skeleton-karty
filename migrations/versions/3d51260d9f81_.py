...
def upgrade():
    ...
    sa.Column('Tomáš', sa.String(), nullable=False),
    sa.Column('Michalovský', sa.String(), nullable=False),
    ...
    op.create_index('ix_loguser_Michalovský', 'loguser', ['Michalovský'], unique=False)
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('karty')
    op.drop_index('ix_loguser_Michalovský', table_name='loguser')
